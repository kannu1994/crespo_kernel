...
#define MAX_BLINK_COUNT 15 /* 10 minutes */
#define BACKLIGHTNOTIFICATION_VERSION 9
/*#define MAX_BLN_TIME 5 // secs  
static int nBln_Time = MAX_BLN_TIME;

static int bln_time_countdown(void)
{
	return (--nBln_Time);
}*/
...
static void enable_led_notification(void)
{
	...
	bln_ongoing = false;//ar
	//bln_disable_backlights();//ar
